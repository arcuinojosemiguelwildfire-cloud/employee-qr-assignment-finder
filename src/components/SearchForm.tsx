...
const SAMPLE_DEMO_IDS = ['EMP00123', 'EMP00124', 'EMP00456', 'EMP00999'];
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {SAMPLE_DEMO_IDS.map((demoId) => (
              <button
                ...
                disabled={isLoading}
                className="px-2.5 py-1 text-xs font-semibold rounded-lg bg-slate-100 hover:bg-indigo-50 hover:text-indigo-700 text-slate-700 border border-slate-200/70 transition-all active:scale-95"
              >
                {demoId}
              </button>
            ))}
